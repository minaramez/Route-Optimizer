...
def main() -> None:
    ...
    # with top_cols[0]:
    #     auditor_count = st.number_input("Number of facilities", min_value=1, max_value=39, value=7, step=1)
    # with top_cols[1]:
    ...
    with top_cols[0]:
        auditor_count = st.number_input(
            "Number of auditors/facilities",
            min_value=1,
            max_value=39,
            value=7,
            step=1,
    ...
    # Hidden UI defaults
    default_arrival_time = datetime.time(8, 30)
    default_pickup_earliest = datetime.time(17, 0)
